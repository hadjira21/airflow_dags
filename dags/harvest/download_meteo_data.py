...
CSV_FILE = os.path.join(DATA_DIR, "temperature_regionale.csv")
...
def download_data():
    ...
    if result.returncode == 0:
        ...
        raise Exception(f"Erreur de téléchargement : {result.stderr}")
...
dag = DAG(
    "temperature_regionale_to_snowflake",
    default_args=default_args,
    schedule_interval="@daily",
    catchup=False,
    description="Téléchargement automatique des températures régionales vers Snowflake"
)
