...
XLS_FILE = os.path.join(EXTRACTED_DIR, "eCO2mix_RTE_Bourgogne-Franche-Comte_En-cours-TR.xls")
...
def download_data():
    ...
    url = "https://eco2mix.rte-france.com/download/eco2mix/eCO2mix_RTE_Bourgogne-Franche-Comte_En-cours-TR.zip"
...
def upload_to_snowflake():
    ...
    snowflake_hook.run("""CREATE OR REPLACE TABLE eco2_data_test_v (
        PERIMETRE VARCHAR,
        NATURE VARCHAR,
        DATE DATE,
        HEURES TIME,
...
dag = DAG(
    "download_data_eco2mix_test_new",
