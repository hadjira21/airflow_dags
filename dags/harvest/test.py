...
ZIP_FILE = os.path.join(DATA_DIR, "eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR.zip")
EXTRACTED_DIR = os.path.join(DATA_DIR, "eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR")
...
def read_data():
    ...
    csv_path = os.path.join(EXTRACTED_DIR, "eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR.csv")
...
"""
    ...
    file_path = '/opt/airflow/data/eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR/eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR.csv'
    ...
    $39, $40, $41 FROM @RTE_STAGE/eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR.csv )
...
csv_file_path = os.path.join(EXTRACTED_DIR, "eCO2mix_RTE_Auvergne-Rhone-Alpes_En-cours-TR.csv")
